...
public:
	static const StationID STATION_NEW = ::NEW_STATION; ///< Build a new station or waypoint
	static const StationID STATION_JOIN_ADJACENT = ::ADJACENT_STATION; ///< Join a neighbouring station or waypoint if one exists
	static const StationID STATION_INVALID = ::INVALID_STATION; ///< Invalid station or waypoint id.
