...
public:
	...
	enum SpecialStationIDs {
		STATION_NEW = 0xFFFFD,           ///< Build a new station
		STATION_JOIN_ADJACENT = 0xFFFFE, ///< Join an neighbouring station if one exists
		STATION_INVALID = 0xFFFFF,       ///< Invalid station id.
	};
