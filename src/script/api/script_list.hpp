...
public:
	 ...
	 */
	typedef btree::safe_btree_map<SQInteger, SQInteger> ScriptListMap;                 ///< Item to value map
	typedef btree::safe_btree_set<std::pair<SQInteger, SQInteger>> ScriptListValueSet; ///< [Value, Item] set
