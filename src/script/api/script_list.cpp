...
public:
	...
	void PostErase(SQInteger, ScriptList::ScriptListMap::iterator, ScriptList::ScriptListValueSet::iterator value_post_erase) override
	{
		if (this->IsEnd()) return;
...
public:
	...
	void PostErase(SQInteger, ScriptList::ScriptListMap::iterator, ScriptList::ScriptListValueSet::iterator) override
	{
		/* not implemented */
	}
...
public:
	...
	void PostErase(SQInteger, ScriptList::ScriptListMap::iterator post_erase, ScriptList::ScriptListValueSet::iterator) override
	{
		if (this->IsEnd()) return;
	...
	void ValueChange(SQInteger) override
	{
		/* do nothing */
	}
...
ScriptList::ScriptListMap::iterator ScriptList::RemoveIter(ScriptListMap::iterator item_iter)
{
	...
	if (this->values_inited) {
		auto new_reverse_iter = this->values.erase(this->values.find(std::make_pair(value, item)));
