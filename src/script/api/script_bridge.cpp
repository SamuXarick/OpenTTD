...
/* static */ bool ScriptBridge::_BuildBridgeRoad1()
{
	...
	return ScriptObject::Command<CMD_BUILD_ROAD>::Do(&::_DoCommandReturnBuildBridge2, start + dir_1, ::DiagDirToRoadBits(dir_2), (::RoadType)ScriptRoad::GetCurrentRoadType(), DRD_NONE, 0);
}
...
/* static */ bool ScriptBridge::_BuildBridgeRoad2()
{
	...
	return ScriptObject::Command<CMD_BUILD_ROAD>::Do(end + dir_2, ::DiagDirToRoadBits(dir_1), (::RoadType)ScriptRoad::GetCurrentRoadType(), DRD_NONE, 0);
}
