...
public:
	 ...
	 */
	enum StartDelay {
		START_DELAY           = DAYS_IN_YEAR * 2,
		START_DELAY_EASY      = START_DELAY,
		START_DELAY_MEDIUM    = DAYS_IN_YEAR,
		START_DELAY_HARD      = DAYS_IN_YEAR / 2,
		START_DELAY_CUSTOM    = START_DELAY_MEDIUM,
		START_DELAY_MIN       = 0,
		START_DELAY_MAX       = 3600,
		START_DELAY_DEVIATION = 60,
		START_DELAY_STEP_SIZE = 30
	};
...
private:
	...
	static uint max_opcodes[MAX_COMPANIES];         ///< Maximum number of opcodes per AI before it's suspended
};
