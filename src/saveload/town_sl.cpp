...
void RebuildTownCaches()
{
	...
	for (const auto t : Map::Iterate()) {
		...
		if (GetHouseNorthPart(house_id) == TileOffset(0, 0)) town->cache.num_houses++;
	}
